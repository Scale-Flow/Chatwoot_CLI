...
func TestPortalsList(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		json.NewEncoder(w).Encode(map[string]any{
			"payload": []map[string]any{
				{"id": 1, "name": "Help Center", "slug": "help"},
			},
		})
	}))
	defer srv.Close()
	...
	Cmd.Root().SetArgs([]string{"application", "help-center", "portals", "list"})
...
func TestArticlesCreate(t *testing.T) {
	...
	Cmd.Root().SetArgs([]string{
		"application", "help-center", "articles", "create",
		"--portal-id", "1",
		"--title", "Getting Started",
	})
	err := Cmd.Root().Execute()
